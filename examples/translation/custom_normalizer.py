...
if __name__ == "__main__":
    ...
    language = sys.argv[1]  # assuming the first argument is the language code
    remove_nuktas = bool(sys.argv[2])  # assuming the second argument is remove_nuktas flag
    nasals_mode = sys.argv[3]  # assuming the third argument is nasals_mode

    # create normalizer instance based on language
    normalizer = IndicNormalizerFactory().get_normalizer(language, remove_nuktas=remove_nuktas, nasals_mode=nasals_mode)
